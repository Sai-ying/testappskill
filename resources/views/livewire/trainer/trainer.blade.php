<div>
    <h1 class="font-bold text-center">Startpagina Trainer</h1>
    ...
    <article class="justify-evenly m-5">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-10 gap-y-5">
            ...
            <x-tmk.form.button type="button" color="dashboard" wire:navigate href="{{ route('trainer.albumsBeheren') }}">Albums beheren</x-tmk.form.button>
            <x-tmk.form.button type="button" color="dashboard" wire:navigate href="{{ route('trainer.spelersbeheren') }}">Spelerslijst</x-tmk.form.button>
            <x-tmk.form.button type="button" color="dashboard" wire:navigate href="{{ route('kalender') }}">Afwezigheid registreren</x-tmk.form.button>
